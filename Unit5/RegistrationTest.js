...
contract('RegistrationTest', function(accounts) {
    ...
    it("Should Register Advertiser", function() {
        return adsHub.registerAdvertiser({from: advertiser})
    ...
    it("Should Register Publisher", function() {
        return adsHub.registerPublisher({from: publisher})
    ...
    it("Should Register Trustee", function() {
        return adsHub.registerTrustee({from: trustee})
            .then(() => adsHub.registeredTrustees(trustee, {from: trustee}))
            .then(isRegistered => assert.isTrue(isRegistered,"should do trustee registration"));       
    });
/*
