...
contract MyGlobalRegistrar
{
	function name(address _owner)constant returns(string );
	function setOwner(string _name,address _newOwner);
	function setAddr(string _name,address _a);
	function addr(string _name)constant returns(address );
	function subRegistrar(string _name)constant returns(address );
	function reserve (string _name) payable;
	function disown(string _name,address _refund);
	function setName(string _name);
	function setSubRegistrar(string _name,address _registrar);
	function content(string _name)constant returns(bytes32 );
	function owner(string _name)constant returns(address );
...
contract UrlHint {
	...
	payable
	{
		MyGlobalRegistrar reg = MyGlobalRegistrar(0x5e70c0bbcd5636e0f9f9316e9f8633feb64d4050);
	...
	function kill() {
		...
		{
			suicide(m_owner);
			MyGlobalRegistrar(0x5e70c0bbcd5636e0f9f9316e9f8633feb64d4050).disown("urlhinter", m_owner);
		}
	}
