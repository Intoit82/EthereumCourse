...
contract('CreateAdsCampaignTest', function(accounts) {
    ...
    it("Should create a new campaign", function() {
        ...
        .then(function(addr){
           ...
           return adsCampaign.CreateNewAdvertimentCampaign(0,1,1,60,80,2,"Http:/adContent",{from:advertiser});
        ...
        .then(function(result){
            var latitude = result[3];
            console.log("result: ", result);
            console.log("latitude: ", latitude.toNumber());
            //assert.strictEqual(latitude,1,"latitude is not verified");
        });
