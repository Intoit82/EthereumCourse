var app = angular.module('AdsHubApp', []);
...
app.controller("AdsHubController", 
  ...
  $scope.setAccount = function() {
    ...
    //me $scope.balance = web3.eth.getBalance($scope.account).toString(10);
//me    var countCampaigns = $scope.campaigns.length;
//me    // the "User Contributed" col needs a new context, so refresh them
//me    for(i=0; i<countCampaigns; i++) {
//me      upsertCampaign($scope.campaigns[i].campaign);
//me    }
...
/* me    if(parseInt($scope.new.goal) > 0 && parseInt($scope.new.duration) > 0) {
...
/* me    if($scope.campaignSelected=="") return;
...
/* me    var campaign = Campaign.at(campaign);
...
/* me    hub.LogNewCampaign( {}, {fromBlock: 0})
...
*/  };
 ...
 /* me   var campaign = Campaign.at(address);
...
/* me    console.log("Upserting campaign", address);
