...
contract Regulator is Owned , RegulatorI {
    ...
    function createNewOperator(
        ...
        returns(TollBoothOperatorI newOperator) 
        {
            ...
            TollBoothOperator newImplementedOperator = new TollBoothOperator(true,deposit,this);
            newImplementedOperator.setOwner(_owner);

            //set operator
            operators[newImplementedOperator] = true;
            
            LogTollBoothOperatorCreated(msg.sender,newImplementedOperator,_owner,deposit);
            
            return newImplementedOperator;
